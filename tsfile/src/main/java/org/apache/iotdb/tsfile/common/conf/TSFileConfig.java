...
public class TSFileConfig implements Serializable {
  ...
  private int groupSizeInByte = 1024 * 1024 * 1024; // set to 1GB
  /** The memory size for each series writer to pack page, default value is 64KB. */
  private int pageSizeInByte = 64 * 1024 * 1024; // set to 64MB
  /** The maximum number of data points in a page, default value is 1024 * 1024. */
  private int maxNumberOfPointsInPage = 1024 * 1024 * 1024;
